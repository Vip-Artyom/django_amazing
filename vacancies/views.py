...
from django_amazing import settings
from vacancies.models import Vacancy, Skill
from vacancies.serializers import VacancyListSerializer, VacancyDetailsSerializer, VacancyCreateSerializer, \
...
class VacancyDetailView(RetrieveAPIView):
    queryset = Vacancy.objects.all()
    serializer_class = VacancyDetailsSerializer
...
class VacancyLikeView(UpdateAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        return JsonResponse(
            VacancyDetailsSerializer(Vacancy.objects.filter(pk__in=request.data), many=True).data, safe=False
        )
